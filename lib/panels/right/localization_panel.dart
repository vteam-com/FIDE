    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                ...
                Center(
                  child: ElevatedButton.icon(
                    ...
                    onPressed: _initializeLocalization,
          ...
          _buildStepItem('Configure l10n settings in pubspec.yaml'),
          _buildStepItem('Create lib/l10n/ directory'),
          _buildStepItem('Generate template ARB files (English + French)'),
          _buildStepItem(
          ...
          const SizedBox(height: 12),
          _buildManualStep('Update main.dart to use AppLocalizations'),
          _buildManualStep('Use AppLocalizations.of(context) in your widgets'),
